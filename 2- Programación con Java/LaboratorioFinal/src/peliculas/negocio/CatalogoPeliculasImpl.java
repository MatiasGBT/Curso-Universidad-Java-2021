...
public class CatalogoPeliculasImpl implements CatalogoPeliculas{
	...
	public void agregarPelicula(String nombreArchivo) {
		...
		double duracion=0;
		try {
			duracion=Double.parseDouble(JOptionPane.showInputDialog("Ingrese la duración de la peli para agregar"));
		} catch (NumberFormatException e) {
			System.out.println("Error, debe ingresar un número. Si tiene decimales utilice '.' y no ','.");

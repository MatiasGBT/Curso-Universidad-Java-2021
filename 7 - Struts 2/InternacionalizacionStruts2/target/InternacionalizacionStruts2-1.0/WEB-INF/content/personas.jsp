...
<html>
    ...
    <body>
        ...
        <!--personas es el path de PersonasAction por convenciones-->
        <s:url var="localeES" action="personas">
            <!--Esto se puede hacer debido a que la calse Action extiende de la clase ActionSupport,
            por lo que maneja en automático la selección de archivo de propiedades depende el idioma-->
            <s:param name="request_locale">es</s:param>
        </s:url>
        <!--localeES y localeEN son variables y pueden tener otro nombre,
        pero es común utilizar locale al tratar con idiomas-->

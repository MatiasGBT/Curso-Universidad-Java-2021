...
public class SecurityConfig extends WebSecurityConfigurerAdapter { //La clase debe extender de la clase WebSecurityConfigurerAdapter
    ...
    //anotación @Service pusimos el nombre "userDetailsService".

    @Bean //Agregando esta anotación hacemos que el objeto BCrypPasswordEncoder este dentro del contenedor de Spring

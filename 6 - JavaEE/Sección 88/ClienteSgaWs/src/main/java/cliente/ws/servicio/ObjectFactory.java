...
public class ObjectFactory {
    ...
    private final static QName _ListarPersonas_QNAME = new QName("http://servicio.sga/", "listarPersonas");
    private final static QName _ListarPersonasResponse_QNAME = new QName("http://servicio.sga/", "listarPersonasResponse");
    private final static QName _Persona_QNAME = new QName("http://servicio.sga/", "persona");
     ...
     */
    @XmlElementDecl(namespace = "http://servicio.sga/", name = "persona")

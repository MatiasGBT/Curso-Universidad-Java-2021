...
public interface ServicioSumarWS {
    ...
    @RequestWrapper(localName = "sumar", targetNamespace = "http://beans/", className = "cliente.ws.servicio.Sumar")
    @ResponseWrapper(localName = "sumarResponse", targetNamespace = "http://beans/", className = "cliente.ws.servicio.SumarResponse")
